...
import { CastClass, CastDocCallback, CastDocResponse, CastTag } from '../shared';
import { CastDtoLike, ToJsonLike } from './index.types';
import { CastHubLike } from '../hub';
import { AssignDtoOpt, AssignType } from '../decorators';

@Fqn(FQN)
export class CastDto implements CastDtoLike {
